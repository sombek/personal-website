...
const projects = [
  ...
  {
    name: 'وصفات منزلية',
    description: 'أحب الطبخ وأحب أشارك الوصفات اللي أجربها في البيت. فقررت أسوي موقع بسيط أكتب فيه وصفاتي المفضلة وأخليها متاحة للكل. الموقع صار طريقة سهلة لتوثيق الوصفات اللي أحبها وأشاركها مع اللي حولي.',
    link: {
  ...
  },
  {
    ...
    description: 'فكرة التطبيق جتني من معاناتي في استخراج بيانات الغياب من النظام الجامعي. سويت هالتطبيق عشان يسهل على الطلاب يطلعون بياناتهم بسرعة وبدون تعقيد. مفيد جدًا لأي طالب في كلية ينبع الجامعية، مع اني ماعتقد ان النظام باقي مثل ماهو بس ممكن تستفيد من الكود',
    link: {
  ...
  },
  {
    ...
    description: 'مع زيادة الاهتمام بالصحة النفسية، لاحظت إن في ناس كثير يدورون على عيادات نفسية. فقررت أسوي صفحة ويب تجمع معلومات عن العيادات النفسية ويساعد الناس يلقون المكان المناسب بسهولة.',
    link: {
  ...
  },
  {
    ...
    description: 'بعد ما شريت ماك جديد، لقيت إني أحتاج وقت طويل لتثبيت البرامج اللي أستخدمها. سويت هذا الموقع عشان أسهل العملية لي ولأي شخص عنده نفس التحدي مع الماك الجديد.',
    link: {
