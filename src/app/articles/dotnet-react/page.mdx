...
import { getMdxContent } from '@/lib/mdxActions'
...
export default async (props) => {
    ...
    const articleContent = await getMdxContent(dirname);
    return <ArticleLayout article={article} children={children} articleContent={articleContent} />
}
